  ...
  <div class="all">
    <div class="large_title">
      ...
      <div class="feedback">
        ...
        <div class="kuang">
          <img src="../assets/img/kuang.png" style="width: 100%" />
          <div class="suggest">
            <el-input
              size="small"
              type="textarea"
...
<script>
import list from "../utils/listNew";
import ranking from "../utils/rankingNew";
import tableList from "../utils/tableListNew";
export default {
  data() {
    return {
      projectList: [
      ...
      imgList: [
        {
          src: require("@/assets/img/zp1.png"),
          score: 94.1,
        },
        {
          src: require("@/assets/img/zp2.png"),
          score: 92.3,
        },
        {
          src: require("@/assets/img/zp3.png"),
          score: 91.8,
        },
      ],
      rankingList: ranking,
...
.team {
  ...
  .team_png {
    height: 100%;
    background: url("../assets//img/jinzita2.png") no-repeat;
